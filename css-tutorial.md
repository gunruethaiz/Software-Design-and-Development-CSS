...
<body>
    <div class="product-container">
        <div class="product-card">
            <div class="product-image" style="background-image: url('images/lab3.1.png');"></div>
            <div class="product-info">
        ...
        <div class="product-card">
            <div class="product-image" style="background-image: url('images/lab3.2.png');"></div>
            <div class="product-info">
        ...
        <div class="product-card">
            <div class="product-image" style="background-image: url('images/lab3.3.png');"></div>
            <div class="product-info">
        ...
        <div class="product-card">
            <div class="product-image" style="background-image: url('images/lab3.4.png');"></div>
            <div class="product-info">
...
```
![คำอธิบายรูป](![Screenshot 2025-02-11 141130](https://github.com/user-attachments/assets/1e273ff8-f61e-41b1-81d8-fd1321acfdb1)
)
...
```
  ![คำอธิบายรูป](![Screenshot 2025-02-11 144210](https://github.com/user-attachments/assets/c4d61bc1-58e5-424f-b38c-1305db4498e5))
...
<body>
    <div class="product-grid">
        <!-- สินค้าชิ้นที่ 1 -->
        <div class="product-card">
            <div class="product-image" style="background-image: url('/lab6.html/images/pro6.1.png')"></div>
            <div class="product-details">
                <h3 class="product-title">สินค้าตัวอย่างที่ 1</h3>
                <div class="product-price">฿1,299</div>
                <div class="product-action">
        ...
        <!-- สินค้าชิ้นที่ 2 -->
        <div class="product-card">
            <div class="product-image" style="background-image: url('/lab6.html/images/pro6.2.png')"></div>
            <div class="product-details">
                <h3 class="product-title">สินค้าตัวอย่างที่ 2</h3>
                <div class="product-price">฿1,499</div>
                <div class="product-action">
        ...
        <!-- สินค้าชิ้นที่ 3 -->
        <div class="product-card">
            <div class="product-image" style="background-image: url('/lab6.html/images/pro6.3.png')"></div>
            <div class="product-details">
        ...
        <!-- สินค้าชิ้นที่ 4 -->
        <div class="product-card">
            <div class="product-image" style="background-image: url('/lab6.html/images/pro6.4.png')"></div>
            <div class="product-details">
...
```
  ![คำอธิบายรูป](![Screenshot 2025-02-11 145806](https://github.com/user-attachments/assets/afae2a45-d88d-4282-a663-15d6da8d914b)
